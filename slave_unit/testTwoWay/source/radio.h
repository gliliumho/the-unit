...
extern unsigned char SlaveReceive(unsigned char *b);
extern void SlaveOp(unsigned char groupID, unsigned char uniqueID);
extern void SlaveRelay(unsigned char *b);